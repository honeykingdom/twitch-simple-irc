...
export interface MessageTags extends Pick<ATags, 'badgeInfo' | 'badges' | 'color' | 'displayName' | 'emotes' | 'id' | 'mod' | 'roomId' | 'tmiSentTs' | 'userId'> {
    /**
...
export declare type GlobalUserStateTags = Pick<ATags, 'badgeInfo' | 'badges' | 'color' | 'displayName' | 'emoteSets' | 'userId'>;
/**
...
export declare enum UserNoticeType {
    sub = "sub",
    resub = "resub",
    subgift = "subgift",
...
interface ABaseUserNoticeTags extends Pick<ATags, 'badgeInfo' | 'badges' | 'color' | 'displayName' | 'emotes' | 'id' | 'mod' | 'roomId' | 'tmiSentTs' | 'userId'> {
    /**
...
interface UserNoticeTagsSub extends ABaseUserNoticeTags, Pick<AUserNoticeTags, 'msgParamCumulativeMonths' | 'msgParamShouldShareStreak' | 'msgParamStreakMonths' | 'msgParamSubPlan' | 'msgParamSubPlanName'> {
    /**
     * The type of notice (not the ID).
     */
    msgId: 'sub';
}
interface UserNoticeTagsResub extends ABaseUserNoticeTags, Pick<AUserNoticeTags, 'msgParamCumulativeMonths' | 'msgParamShouldShareStreak' | 'msgParamStreakMonths' | 'msgParamSubPlan' | 'msgParamSubPlanName'> {
    msgId: 'resub';
}
interface UserNoticeTagsSubGift extends ABaseUserNoticeTags, Pick<AUserNoticeTags, 'msgParamMonths' | 'msgParamRecipientDisplayName' | 'msgParamRecipientId' | 'msgParamRecipientUserName' | 'msgParamSubPlan' | 'msgParamSubPlanName'> {
    msgId: 'subgift';
}
interface UserNoticeTagsAnonSubGift extends ABaseUserNoticeTags, Pick<AUserNoticeTags, 'msgParamMonths' | 'msgParamRecipientDisplayName' | 'msgParamRecipientId' | 'msgParamRecipientUserName' | 'msgParamSubPlan' | 'msgParamSubPlanName'> {
    msgId: 'anonsubgift';
}
interface UserNoticeTagsSubMysteryGift extends ABaseUserNoticeTags {
    msgId: 'submysterygift';
}
interface UserNoticeTagsGiftPaidUpgrade extends ABaseUserNoticeTags, Pick<AUserNoticeTags, 'msgParamPromoGiftTotal' | 'msgParamPromoName' | 'msgParamSenderLogin' | 'msgParamSenderName'> {
    msgId: 'giftpaidupgrade';
}
interface UserNoticeTagsAnonGiftPaidUpgrade extends ABaseUserNoticeTags, Pick<AUserNoticeTags, 'msgParamPromoGiftTotal' | 'msgParamPromoName'> {
    msgId: 'anongiftpaidupgrade';
}
interface UserNoticeTagsRewardGift extends ABaseUserNoticeTags {
    msgId: 'rewardgift';
}
interface UserNoticeTagsRaid extends ABaseUserNoticeTags, Pick<AUserNoticeTags, 'msgParamDisplayName' | 'msgParamLogin' | 'msgParamViewerCount'> {
    msgId: 'raid';
}
interface UserNoticeTagsUnraid extends ABaseUserNoticeTags {
    msgId: 'unraid';
}
interface UserNoticeTagsRitual extends ABaseUserNoticeTags, Pick<AUserNoticeTags, 'msgParamRitualName'> {
    msgId: 'ritual';
}
interface UserNoticeTagsBitsBadGetier extends ABaseUserNoticeTags, Pick<AUserNoticeTags, 'msgParamThreshold'> {
    msgId: 'bitsbadgetier';
}
declare type UserNoticeTags = UserNoticeTagsSub | UserNoticeTagsResub | UserNoticeTagsSubGift | UserNoticeTagsAnonSubGift | UserNoticeTagsSubMysteryGift | UserNoticeTagsGiftPaidUpgrade | UserNoticeTagsAnonGiftPaidUpgrade | UserNoticeTagsRewardGift | UserNoticeTagsRaid | UserNoticeTagsUnraid | UserNoticeTagsRitual | UserNoticeTagsBitsBadGetier;
/**
...
export interface WhisperTags extends Pick<ATags, 'badges' | 'color' | 'displayName' | 'emotes' | 'userId'> {
    /**
     * (Not documented)
     */
    messageId: string;
